...
export class ProductService {
  ...
  public markAsCancelled(orderId) {
    return this.httpClient.get("http://localhost:9090/markOrderAsCancelled/"+orderId);
  }

  public markAsCancelledByUser(orderId) {
    return this.httpClient.get("http://localhost:9090/markOrderAsCancelledByUser/"+orderId);
  }

  public markAsSuccessful(orderId) {
    return this.httpClient.get("http://localhost:9090/markOrderAsSuccessful/"+orderId);
  }
  ...
  public getMyOrders(status: string): Observable<MyOrderDetails[]> {
    return this.httpClient.get<MyOrderDetails[]>("http://localhost:9090/getOrderDetails/"+status);
  }
